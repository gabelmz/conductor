...
const SIDEBAR_PRESETS = {
  commerce: {
    ...
    sections: [
      ...
      { label: 'Catalog',     items: ['products', 'listings', 'variations', 'ingest', 'flatfile', 'keepa', 'svl', 'brandcompare', 'regs', 'tasks', 'reports', 'guidelines'] },
      { label: 'Automation',  items: ['automations', 'workflowbuilder', 'processes', 'bernie'] },
      { label: 'AI',          items: ['aichat', 'agents', 'aiworkflows', 'agentbuilder', 'features'] },
  ...
  functional: {
    ...
    sections: [
      { label: 'Catalog',    items: ['products', 'listings', 'variations', 'ingest', 'flatfile', 'keepa', 'svl', 'brandcompare', 'compliance', 'regs', 'tasks'] },
      { label: 'Automation', items: ['automations', 'workflowbuilder', 'processes', 'bernie'] },
      { label: 'AI',         items: ['aichat', 'agents', 'agentbuilder', 'features'] },
      { label: 'Knowledge',  items: ['sops', 'runbooks', 'policies'] },
  ...
  classic: {
    ...
    sections: [
      { label: 'Main',         items: ['chat', 'dashboard'] },
